...
html_content = requests.get(
    url="https://dblp.uni-trier.de/db/conf/sigir/sigir2025.html", headers=headers
).text
...
urls = soup.find_all(
    "a",
    {
        "href": re.compile(r"^https://doi.org/10.1145/3726302.\d*"),
        "itemprop": "url",
    },
)
...
df.to_csv("parsed_data/sigir_2025.csv")
