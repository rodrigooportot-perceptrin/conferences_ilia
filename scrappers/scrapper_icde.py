...
html_content = requests.get(
    url="https://dblp.uni-trier.de/db/conf/icde/icde2025.html", headers=headers
).text
...
# https://doi.org/10.1109/ICDE65448.2025.00005
...
urls = soup.find_all(
    "a",
    {
        "href": re.compile(r"^https://doi.org/10.1109/ICDE\d*.2025.\d*"),
        "itemprop": "url",
    },
)
...
df.to_csv("parsed_data/icde_2025.csv")
